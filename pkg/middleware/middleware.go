...
var (
	...
	ReqSignedIn            = Auth(&AuthOptions{ReqSignedIn: true, ReqHasRole: false})
	ReqSignedInNoAnonymous = Auth(&AuthOptions{ReqSignedIn: true, ReqNoAnonynmous: true, ReqHasRole: true})
